...
impl SteadyDiffAdv {
    ...
    pub fn new(limiter_type: LimiterType) -> SteadyDiffAdv {
        SteadyDiffAdv {
    ...
    pub fn add_domain(&mut self, dom1d: usize, conc: usize, diff_coeff: usize, vel_x: usize, src: usize) {
