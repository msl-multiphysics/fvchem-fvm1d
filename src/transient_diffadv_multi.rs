...
pub struct TransientDiffAdvMulti {
    // internal data
...
impl TransientBase for TransientDiffAdvMulti {
    fn assemble_matrix(
        &self,
        prob: &Problem1D,
...
impl TransientDiffAdvMulti {
    pub fn new(num_comp: usize, limiter_type: LimiterType) -> TransientDiffAdvMulti {
        TransientDiffAdvMulti {
