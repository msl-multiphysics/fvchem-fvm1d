...
NR = 0.50  # right boundary concentration

# numerical solution
num_df = pd.read_csv('fvchem_fvm1d/examples/output_steady_diffadv_bndnadv/c_face.csv')
...
c_ana = cL + (-NR/u * np.exp(-u*L/D)) * (np.exp(u*x_ana/D) - 1)
