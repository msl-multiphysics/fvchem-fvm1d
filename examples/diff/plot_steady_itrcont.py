...
# numerical solution
numA_df = pd.read_csv('fvchem_fvm1d/examples/output_steady_itrcont/ca_face.csv')
numB_df = pd.read_csv('fvchem_fvm1d/examples/output_steady_itrcont/cb_face.csv')
