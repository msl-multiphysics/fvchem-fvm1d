...
fn main() {
    ...
    let c_a = Problem1D::add_var1d(
        ...
        dom_a,
        1.0,
        "examples/output_steady_diff_itrmtrn/ca".to_string(),
        0,
    ).unwrap();
    ...
    let c_b = Problem1D::add_var1d(
        ...
        dom_b,
        1.0,
        "examples/output_steady_diff_itrmtrn/cb".to_string(),
        0,
    ).unwrap();
    ...
    let k_ab = Problem1D::add_scl0d(&mut prob, dom_ar, 0.2, "".to_string(), 0).unwrap();
