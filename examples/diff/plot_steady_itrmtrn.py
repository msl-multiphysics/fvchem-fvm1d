...
# numerical solution
numA_df = pd.read_csv('fvchem_fvm1d/examples/output_steady_itrmtrn/ca_face.csv')
numB_df = pd.read_csv('fvchem_fvm1d/examples/output_steady_itrmtrn/cb_face.csv')
...
c2 = NR - RB*(LA + LB)
c1 = c2 + LA*(RB - RA)
c4 = (-RA/2/DA)*LA**2 - (c1/DA)*LA + c3 + (RB/2/DB)*LA**2 + (c2/DB)*LA - (RA*LA + c1)/k 
