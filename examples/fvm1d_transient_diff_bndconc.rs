...
fn main()
{
    ...
    // add properties
    create_dir_all("examples/output_transient_diff_bndconc").unwrap();
    let c = Problem1D::add_var1d(&mut prob, dom, 1.0, "examples/output_transient_diff_bndconc/c".to_string(), 20);
    ...
    solver.solve(&mut prob, 0.01, 101, 1000, 1e-6, 1.0);
